...
# ---------- Start Tests for plot_reg_combine ----------

test_that("plot_reg_combine basic run produces a ggplot", {
  p <- plot_reg_combine(
...
test_that("plot_reg_combine with custom order_y", {
  p <- plot_reg_combine(
    tbl_uni = uni_rr_robpos,
    tbl_multi = multi_rr_full_model,
    order_y = exposures
...
test_that("plot_reg_combine with log_x = TRUE", {
  p <- plot_reg_combine(
    tbl_uni = uni_rr_robpos,
    tbl_multi = multi_rr_full_model,
    log_x = TRUE
...
test_that("plot_reg_combine with custom order_y and log_x together", {
  p <- plot_reg_combine(
    tbl_uni = uni_rr_robpos,
    tbl_multi = multi_rr_full_model,
    order_y = exposures,
