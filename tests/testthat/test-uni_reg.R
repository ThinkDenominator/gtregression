test_that("uni_reg computes estimates correctly across approaches", {
  ...
  # Check model and summary access
  linear_result <- suppressWarnings(
    uni_reg(
      data = pima_data,
      outcome = "mass",
  ...
  expect_type(linear_result$models, "list")
  expect_type(linear_result$model_summaries, "list")
  expect_type(linear_result$reg_check, "list")
