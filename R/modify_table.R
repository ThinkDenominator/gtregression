...
#'
#' Allows customization of variable names, level labels, column headers, and captions in regression summary tables.
#' Designed for use with tables generated by `gtsummary` functions such as `uni_reg()` or `multi_reg()`.
#'
#' @param gt_table A `gtsummary` table object (e.g., from `uni_reg()` or `multi_reg()`).
