...
Kaplan-Meier survival summary {.table .cl-f037a018
...
Kaplan-Meier survival probabilities {.table .cl-f05a7aac
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-f088008a
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-f0ae7558 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-f1510304
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-f20f67c2
quarto-disable-processing="true"}
