...
Kaplan-Meier survival summary {.table .cl-d07e7778
...
Kaplan-Meier survival probabilities {.table .cl-d0a0251c
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-d0cc68fc
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-d0f208d2 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-d1be0f90
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-d2958a92
quarto-disable-processing="true"}
