...
Kaplan-Meier survival summary {.table .cl-0b6fb0fc
...
Kaplan-Meier survival probabilities {.table .cl-0b8ea89a
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-0bb7586c
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-0bda24d2 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-0c6db6fc
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-0d1710f8
quarto-disable-processing="true"}
