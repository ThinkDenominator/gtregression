...
Kaplan-Meier survival summary {.table .cl-43ed941c
...
Kaplan-Meier survival probabilities {.table .cl-440edac8
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-443ab47c
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-446031b6 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-452ec0da
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-4618bcee
quarto-disable-processing="true"}
