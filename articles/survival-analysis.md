...
Kaplan-Meier survival summary {.table .cl-d83906b2
...
Kaplan-Meier survival probabilities {.table .cl-d8593e50
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-d884315a
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-d8a85706 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-d96c5c1e
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-da3daeb8
quarto-disable-processing="true"}
