...
Kaplan-Meier survival summary {.table .cl-d3655a0a
...
Kaplan-Meier survival probabilities {.table .cl-d38686ee
quarto-disable-processing="true"}
...
Restricted mean survival time {.table .cl-d3b2f83c
quarto-disable-processing="true"}
...
Log-rank test {.table .cl-d3d89b00 quarto-disable-processing="true"}
...
Parametric survival model comparison {.table .cl-d4a39030
quarto-disable-processing="true"}
...
Predicted survival probabilities {.table .cl-d5793bb8
quarto-disable-processing="true"}
