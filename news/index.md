...
- Added support for logit, logbinomial, linear, Poisson, roboisson, and
...
- Reproducible-code panes for tables/models. \## Changed
- Improved validation helpers; clearer error messages. \## Fixed
